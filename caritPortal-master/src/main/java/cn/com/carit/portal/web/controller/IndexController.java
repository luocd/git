...
public class IndexController extends BaseController{
	...
	public String index(){
		doLocalIndex(getLocaleLanguage(Locale.SIMPLIFIED_CHINESE));
		return "index";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value="/{language}/news_list", method=RequestMethod.GET)
	public String newsIndex(@PathVariable String language, Model model){
		defaultAttribute(language);
		model.addAttribute("catalogList", CacheManager.getInstance().getAllCatalogList());
		return "news_list";
	}
