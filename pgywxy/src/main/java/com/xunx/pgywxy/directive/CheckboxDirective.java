...
public class CheckboxDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		StringBuffer stringBuffer = new StringBuffer("<input type=\"checkbox\" name=\"" + name
				+ "\" value=\"" + fieldValue + "\"");
		...
		stringBuffer.append(" /><input type=\"hidden\" id=\"__checkbox_" + id
				+ "\" name=\"__checkbox_" + name + "\" value=\"" + fieldValue + "\"");
		if (disabled) {
			stringBuffer.append(" disabled=\"disabled\"");
		}
		stringBuffer.append(" />");
