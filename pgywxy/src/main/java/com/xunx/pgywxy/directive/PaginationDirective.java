package com.xunx.pgywxy.directive;
...
import com.xunx.pgywxy.bean.Pager.Order;
import com.xunx.pgywxy.util.DirectiveUtil;
...
public class PaginationDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		List<String> urlList = (ArrayList<String>) DirectiveUtil.getObjectParameter(
				URL_LIST_PARAMETER_NAME, params);
		Integer maxPageItemCount = DirectiveUtil.getIntegerParameter(
				MAX_PAGE_ITEM_COUNT_PARAMETER_NAME, params);
		Map<String, String> parameterMap = (HashMap<String, String>) DirectiveUtil
				.getObjectParameter(PARAMETER_MAP_PARAMETER_NAME, params);
		...
		if (pager != null) {
			...
			if (StringUtils.isNotEmpty(searchBy)) {
				parameterStringBuffer.append("&pager.searchBy="
						+ URLEncoder.encode(searchBy, "UTF-8"));
			}
			if (StringUtils.isNotEmpty(keyword)) {
				parameterStringBuffer.append("&pager.keyword="
			...
			if (parameterMap != null) {
				for (String parameterKey : parameterMap.keySet()) {
					...
					if (StringUtils.isNotEmpty(parameterKey)
							&& StringUtils.isNotEmpty(parameterValue)) {
						parameterStringBuffer.append("&" + parameterKey + "="
