...
import com.xunx.pgywxy.util.LogConfigUtil;
import com.xunx.pgywxy.web.action.admin.BaseAdminAction;
			...
			if (!StringUtils.equals(result, BaseAdminAction.ERROR)) {
				...
				if (allLogConfigList != null) {
					for (LogConfig logConfig : allLogConfigList) {
						if (StringUtils.equals(logConfig.getActionClass(), actionClass)
								&& StringUtils.equals(logConfig.getActionMethod(), actionMethod)) {
