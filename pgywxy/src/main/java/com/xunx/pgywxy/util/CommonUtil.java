...
public class CommonUtil {
	...
	public static final String WEB_APP_ROOT_KEY = "xunx.webAppRoot";// WebRoot路径KEY
	...
	public static String getPreparedStatementPath(String path) {
		...
		Matcher dateMatcher = Pattern.compile(PATH_PREPARED_STATEMENT_DATE).matcher(
				uuidStringBuffer.toString());
