...
public class DirectiveUtil {
	 ...
	 * @return 参数值
	 */
	public static String getStringParameter(String name, Map<String, TemplateModel> params)
	 ...
	 * @return 参数值
	 */
	public static Integer getIntegerParameter(String name, Map<String, TemplateModel> params)
			throws TemplateModelException {
		TemplateModel templateModel = params.get(name);
		if (templateModel == null) {
			return null;
	 ...
	 * @return 参数值
	 */
	public static Boolean getBooleanParameter(String name, Map<String, TemplateModel> params)
			throws TemplateModelException {
		TemplateModel templateModel = params.get(name);
		if (templateModel == null) {
			return null;
	 ...
	 * @return 参数值
	 */
	public static Date getDateParameter(String name, Map<String, TemplateModel> params)
			throws TemplateModelException {
		TemplateModel templateModel = params.get(name);
		if (templateModel == null) {
			return null;
		...
		if (templateModel instanceof TemplateScalarModel) {
			...
			try {
				String[] pattern = new String[] { "yyyy-MM", "yyyyMM", "yyyy/MM", "yyyyMMdd",
	 ...
	 * @return 参数值
	 */
	public static Object getObjectParameter(String name, Map<String, TemplateModel> params)
			throws TemplateModelException {
		TemplateModel templateModel = params.get(name);
		if (templateModel == null) {
			return null;
