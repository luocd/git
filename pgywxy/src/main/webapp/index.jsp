...
<%@page import="com.xunx.pgywxy.util.SpringUtil"%>
<%@page import="com.xunx.pgywxy.service.account.AdminService"%>
<%@page import="com.xunx.pgywxy.entity.account.Admin"%>
<%@page import="com.xunx.pgywxy.util.SettingUtil"%>
<%@page import="com.xunx.pgywxy.bean.Setting"%>
<%
